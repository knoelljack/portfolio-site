    ...
    <div className="w-full">
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 auto-rows-fr">
        {projects.map((project, idx) => (
          ...
          >
            <CardContainer containerClassName="py-0 flex-1">
              <CardBody className="bg-gray-900 dark:bg-black dark:border-white/[0.1] border-gray-700 w-full h-full p-6 rounded-lg border group/card flex flex-col">
                <CardItem translateZ="50" className="text-xl font-semibold mb-4 text-white">
                  {project.title}
                </CardItem>
                <CardItem translateZ="60" className="text-gray-300 mb-4 text-sm">
                  {project.description}
                </CardItem>
