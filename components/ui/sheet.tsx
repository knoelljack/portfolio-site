...
>(({ side = 'right', className, children, onOpenAutoFocus, ...props }, ref) => {
  return (
    <SheetPortal>
      ...
      >
        {children}
        <SheetPrimitive.Close className="absolute right-4 top-4 rounded-sm opacity-70 ring-offset-background transition-opacity hover:opacity-100 focus:outline-none focus:ring-2 focus:ring-white/20 focus:ring-offset-2 disabled:pointer-events-none text-white hover:bg-white/10 p-2">
          <X className="h-6 w-6" />
